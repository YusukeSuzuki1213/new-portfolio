...
<img width="1680" alt="スクリーンショット 2020-03-22 22.00.20.png" src="https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/b2d82807-c200-acd5-0dc3-d0bc7f541035.png">
次にAndroidアイコンボタンをクリックし、AndroidアプリにFirebaseを追加します。そうすると画像のようなページが表示されます。設定ファイルのダウンロードやSDKの追加など、手順にしたがって、セットアップをしてください。
![スクリーンショット 2020-05-29 00.23.25.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/64cbd944-7a87-d5f0-fd5e-7af1110c324f.png)
...
![スクリーンショット 2020-05-30 18.01.45.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/afdc43ea-c8d1-08da-b590-32a62f39c756.png)
...
![スクリーンショット 2020-05-30 18.16.18.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/b6e38fc6-f937-c841-18c9-4df61023ad7b.png)
...
![スクリーンショット 2020-05-30 18.26.12.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/21cb5d01-706d-908f-55d6-c4deceff0f8a.png)

![スクリーンショット 2020-05-30 18.30.58.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/d58c1269-1c00-f8fe-6d4a-ab2d8ceca7b1.png)
...
![スクリーンショット 2020-05-30 19.26.17.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/14244d50-9ca1-8df4-9ee3-6da43455ff9f.png)
...
![スクリーンショット 2020-05-30 19.34.38.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/8da59839-2fdf-e08a-2df1-7e2de761f120.png)

### 8. ワークフローを起動する
上記までで設定は全て整いました。次は実際にワークフローを起動します。ワークフローでは`on: pull_request`と設定しているため、レポジトリにプルリクエストを出します。そうすると画像のように、ワークフローが実行されます。
![スクリーンショット 2020-05-30 19.48.30.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/247be73c-07c8-c3db-aadd-0be92a72c482.png)

# 結果
最後にFirebase Test Labのテスト結果を簡単に紹介します。
端末のテスト結果の「Robo」タブを開くと画像のようなRoboが実際に行なったクロールの詳細がわかります。
(クロールグラフに表示されている日本語が文字化けしてるの気になる。。。)
![スクリーンショット 2020-05-30 20.55.04.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/4fbb18d6-0c02-bf09-4a18-ba3522af7ed5.png)

「ログ」タブでは画像のようにクロールのログがわかります。
もしクラッシュ等が発生したら、その詳細をこのログで確認することができます。
![スクリーンショット 2020-05-30 20.59.45.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/875d9bae-0f99-f746-0e97-13326b86f4bc.png)

「動画」タブでは、クロールの様子を動画で確認することが可能です。
![robo.gif](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/4ee1652e-3f59-e09a-d07f-3b199f0ad0f3.gif)

「パフォーマンス」タブでは、パフォーマンスを確認することができます。
例えば、Roboのある操作タイミングに、どれくらいCPU、メモリ、ネットワークを使用したか等がわかります。
![スクリーンショット 2020-05-30 21.12.13.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/199988/0420aac4-f675-dda8-9238-16a4b8a3072a.png)
